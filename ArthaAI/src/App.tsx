...
export function App() {
  ...
  if (currentView === "loading") {
    return (
      <div className="flex min-h-screen items-center justify-center page-canvas p-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="hidden items-center gap-1 rounded-xl border border-slate-200/90 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 sm:flex"
              >
                <span>Tools</span>
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200/90 bg-white text-slate-700 transition hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              {darkMode ? (
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200/90 bg-white text-[#12233a] transition hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
              title="AI Assistant"
            >
            ...
            <button
              ...
              className="msme-btn min-h-[40px] px-3.5 py-2 text-xs"
            >
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        ...
        {currentView === "onboarding" ? (
          <div className="mx-auto max-w-xl py-2">
            ...
            <div className="msme-card p-6 sm:p-8">
              ...
              <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                ...
                <button
                  ...
                  className="flex min-h-[44px] items-center gap-2 rounded-xl bg-[#1d4ed8] px-5 py-2.5 text-xs font-bold text-white shadow-[0_6px_16px_rgba(29,78,216,0.22)] transition hover:bg-[#1e40af] active:scale-98"
                >
                  <span>{step === 4 ? "See matching schemes" : "Continue"}</span>
          ...
          <div className="space-y-6">
            ...
            <div className="msme-card p-5 sm:p-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-2">
                    <h1 className="font-display text-2xl font-semibold text-[#12233a] dark:text-white">
                      {profile.size} {profile.industry}
                    </h1>
                    <span
                      className={`rounded-full px-2.5 py-0.5 text-[11px] font-semibold ${
                        profile.udyamStatus === "registered"
                          ? "bg-emerald-50 text-emerald-800 ring-1 ring-emerald-200 dark:bg-emerald-950 dark:text-emerald-300 dark:ring-emerald-800"
                          : "bg-amber-50 text-amber-800 ring-1 ring-amber-200 dark:bg-amber-950 dark:text-amber-300 dark:ring-amber-800"
                      }`}
                    >
                      {profile.udyamStatus === "registered" ? "Udyam registered" : "Udyam pending"}
                    </span>
                  </div>
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    {profile.city ? `${profile.city}, ` : ""}
                    {profile.state}
                    {profile.udyamNumber ? ` · ${profile.udyamNumber}` : ""}
                  </p>
                </div>
              ...
              {analysis && (
                <div className="mt-5 grid grid-cols-2 gap-2 border-t border-slate-100 pt-4 dark:border-slate-800 sm:grid-cols-4">
                  {[
                    { label: "Schemes matched", value: analysis.totalOpportunitiesCount },
                    { label: "Highly relevant", value: analysis.highlyRelevantCount },
                    { label: "Priority actions", value: analysis.highPriorityCount },
                    { label: "Verified sources", value: analysis.matchHighlights.verifiedSourcesCount },
                  ].map((stat) => (
                    <div key={stat.label} className="rounded-xl bg-[#e8f2ff] px-3 py-2.5 dark:bg-slate-950/60">
                      <p className="font-display text-xl font-semibold text-[#12233a] dark:text-white">
                        {stat.value}
                      </p>
            ...
            {analysis && (
              <div className="msme-card p-5 sm:p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="eyebrow text-blue-800 dark:text-blue-300">
            ...
            <div className="space-y-3.5">
              <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <h2 className="font-display text-2xl font-semibold text-[#12233a] dark:text-white">
                    Schemes that fit your unit
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex min-h-[36px] shrink-0 items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-semibold transition ${
                        isActive
                          ? "bg-[#12233a] text-white shadow-sm dark:bg-blue-600"
