...
export function OnboardingProgressBar({ step }: { step: number }) {
  ...
  return (
    <div className="mb-8" id="onboarding-progress-bar">
        ...
        {[0, 1, 2, 3].map((i) => (
          <div
            ...
            className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${
              i <= step ? "bg-[#1d4ed8]" : "bg-slate-200 dark:bg-slate-800"
            }`}
          />
        ))}
      </div>
  ...
  return (
    <button
      ...
      className={`min-h-[50px] w-full rounded-xl border-2 p-3.5 text-left transition active:scale-[0.99] ${
        selected
          ? "border-[#1d4ed8] bg-blue-50/80 dark:border-blue-500 dark:bg-blue-950/40"
...
export function StepIndustry({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="font-display text-xl font-semibold text-[#12233a] dark:text-white sm:text-2xl">
          What does your unit make or do?
        </h2>
        <p className="mt-1 mb-5 text-sm text-slate-500 dark:text-slate-400">
          We’ll match GeM tenders, subsidies and credit to this sector.
        </p>
...
export function StepSize({
  ...
  return (
    <div>
      ...
      <p className="mt-1 mb-5 text-sm text-slate-500 dark:text-slate-400">
        Official MSME investment and turnover limits decide your subsidy slab and tender quota.
      </p>
...
export function StepUdyam({
  ...
  return (
    <div>
      <h2 className="font-display text-xl font-semibold text-[#12233a] dark:text-white sm:text-2xl">
        Is the unit Udyam registered?
      </h2>
      <p className="mt-1 mb-5 text-sm text-slate-500 dark:text-slate-400">
        Udyam unlocks GeM bidding, EMD waivers and most collateral-free loan schemes.
      </p>
...
export function StepLocation({
  ...
  return (
    <div>
      <h2 className="font-display text-xl font-semibold text-[#12233a] dark:text-white sm:text-2xl">
        Where does the unit operate?
      </h2>
      <p className="mt-1 mb-5 text-sm text-slate-500 dark:text-slate-400">
        State decides which industrial policies and cluster subsidies apply.
      </p>
...
export function StepConfirmation({
  ...
  return (
    <div>
      ...
      <h2 className="font-display mt-2 text-xl font-semibold text-[#12233a] dark:text-white sm:text-2xl">
        Ready to see what your unit can claim?
      </h2>
      <p className="mt-1 mb-5 text-sm text-slate-500 dark:text-slate-400">
        We’ll match this profile against verified MSME schemes — you review before applying.
      </p>
