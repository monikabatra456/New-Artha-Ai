...
export const HeroAnimation: React.FC = () => {
  ...
  return (
    <div className="relative mx-auto mt-8 w-full max-w-md overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-4 shadow-sm transition-all dark:border-slate-800 dark:bg-slate-900/90 sm:max-w-lg sm:p-5">
      {/* Header bar */}
