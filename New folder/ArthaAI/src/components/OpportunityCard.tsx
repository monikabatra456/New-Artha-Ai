...
export const OpportunityCard: React.FC<OpportunityCardProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-2xs transition-all hover:border-blue-300 dark:border-slate-800 dark:bg-slate-900 sm:p-5">
      {/* Top Header / Badges */}
      ...
      {/* Opportunity Title */}
      <h3 className="mt-2.5 text-sm font-bold text-slate-900 dark:text-white sm:text-base">
        {doc.title}
      </h3>
      ...
      <div className="mt-3.5 flex items-center justify-between border-t border-slate-100 pt-3 dark:border-slate-800">
        ...
        <a
          ...
          className="inline-flex min-h-[36px] items-center gap-1.5 rounded-xl bg-blue-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-2xs transition hover:bg-blue-700 active:scale-98"
        >
